        ...
        <section className="space-y-3">
          ...
          >
            ...
            <div className="absolute top-4 left-4 flex items-center gap-2">
              <span className="rounded-full bg-navy-dark/70 backdrop-blur-md px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-gold border border-gold/30">
            ...
            {heroMedia === "image" && property.media.video && (
              <button
                ...
                className="absolute bottom-4 right-4 z-10 flex items-center gap-2 rounded-full bg-gold/90 hover:bg-gold px-4 py-2 text-xs font-bold text-navy-dark shadow-lg transition-all"
              >
        ...
        <section className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12 items-start">
          ...
          <aside className="lg:sticky lg:top-24 space-y-6">
            ...
            <Card className="p-8 glass-card border-gold/30 bg-gold/5 overflow-hidden relative">
              <div className="absolute top-0 right-0 bg-gold px-4 py-1 rounded-bl-2xl text-[10px] font-black uppercase tracking-widest text-navy-dark">
              ...
              <div className="space-y-3">
                {!isOwnerVerified && !canViewContact && (
                  <Button
                    className="w-full h-16 rounded-2xl bg-gold hover:bg-gold-light text-navy-dark font-black text-lg shadow-xl shadow-gold/20 transition-all active:scale-95"
                    asChild={!isVisitor}
                  >
                    {isVisitor ? (
