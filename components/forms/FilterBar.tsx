      ...
      <div className="mx-auto max-w-6xl w-full px-4 sm:px-6">
        <div className="glass-card shadow-2xl shadow-slate-900/40 border border-white/10 rounded-[2.5rem] p-3 flex flex-col gap-3 bg-main-bg/90 backdrop-blur-3xl ring-1 ring-white/10">
          ...
          <div className="relative group w-full">
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2">
              <Button 
                ...
                className="h-12 px-6 rounded-2xl bg-gold text-black font-black text-sm transition-all hover:scale-105 active:scale-95"
              >
                Search
              </Button>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-3">
            ...
            <Button 
              className="h-14 lg:w-auto w-full px-10 bg-gold hover:bg-gold-light text-black font-bold rounded-[1.8rem] transition-all hover:scale-[1.03] active:scale-95 shadow-xl shadow-gold/20 flex items-center justify-center gap-2"
              onClick={handleSearch} 
            >
