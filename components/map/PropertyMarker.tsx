  ...
  return (
    <Marker position={[lat, lng]} icon={customIcon}>
      <Popup closeButton={false} minWidth={300}>
        <div className="group overflow-hidden rounded-3xl bg-[#111827] transition-all hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/5">
          {/* Image Header */}
          <div className="relative h-44 w-full overflow-hidden">
            ...
            <div className="absolute bottom-4 right-4 rounded-xl bg-[#0b1220]/80 px-3 py-1.5 text-[10px] font-black uppercase tracking-widest text-[#e6c76e] backdrop-blur-md border border-[#c9a646]/20">
          ...
          <div className="p-5">
            ...
            <Link
              ...
              className="mt-5 flex w-full items-center justify-center gap-3 rounded-2xl bg-[#c9a646] py-4 text-xs font-black uppercase tracking-[0.2em] text-[#0a1f44] transition-all hover:bg-[#e6c76e] hover:shadow-[0_0_20px_rgba(201,166,70,0.3)] active:scale-[0.98]"
            >
              View Listing
